...
void
MeshbornFilter::from_xml(pugi::xml_node node)
{
...
void
MeshbornFilter::to_statepoint(hid_t filter_group) const
{
...
void
MeshbornFilter::set_mesh(int32_t mesh)
{
  mesh_ = mesh;
  n_bins_ = 1;
...
openmc_meshborn_filter_get_mesh(int32_t index, int32_t* index_mesh)
{
  ...
  auto* filt = dynamic_cast<MeshbornFilter*>(filt_base);
