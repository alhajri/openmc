...
void
ImportanceFilter::from_xml(pugi::xml_node node)
{
...
void
ImportanceFilter::set_importance(gsl::span<const double> importance)
{
...
void
ImportanceFilter::to_statepoint(hid_t filter_group) const
{
...
std::string
ImportanceFilter::text_label(int bin) const
{
...
void
ImportanceFilter::set_mesh(int32_t mesh)
{
  mesh_ = mesh;
